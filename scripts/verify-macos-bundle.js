...
assertIncludes(traySwitchRs, "pub fn select_node", "Status-bar node selection helper");
assertIncludes(traySwitchRs, "if group.nodes[target_index].enabled", "Status-bar active node no-op");
