...
这是 Hosts Switch 的 macOS 预发布构建，用于验证 Tauri + React 版 hosts 切换工具。`v0.1.15` 基于 `v0.1.14` 继续加固状态栏切换、profiles 可恢复性和手工验收流程。
...
- GitHub Release notes 继续从仓库内受校验的 `docs/release/release-notes-v0.1.15.md` 渲染发布，减少发布页面和源码记录不一致。
...
Automated prerelease build for v0.1.15.

Artifact:

- Hosts.Switch_0.1.15_aarch64.dmg
- SHA-256: `73f7300dad25300ad9d27dc82e7c59ed9fff20620595dd3eb99cb6abd5a610a3`
