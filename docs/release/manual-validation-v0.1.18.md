# Hosts Switch v0.1.18 Manual Validation
...
- Tag: `v0.1.18`
- Release asset: `Hosts.Switch_0.1.18_aarch64.dmg`
- Local bundle name: `Hosts Switch_0.1.18_aarch64.dmg`
- Release: <https://github.com/kaelinda/hosts-switch/releases/tag/v0.1.18>
- Structured result: `docs/release/manual-validation-v0.1.18.result.json`
...
- [ ] Install or open the packaged app from the verified release asset `manual-validation-artifacts/v0.1.18/Hosts.Switch_0.1.18_aarch64.dmg`.
...
- Update `docs/release/manual-validation-v0.1.18.result.json` with the same outcome.
