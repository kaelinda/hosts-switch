# Hosts Switch v0.1.12 Manual Validation
...
- Tag: `v0.1.12`
- Release asset: `Hosts.Switch_0.1.12_aarch64.dmg`
- Local bundle name: `Hosts Switch_0.1.12_aarch64.dmg`
- Release: <https://github.com/kaelinda/hosts-switch/releases/tag/v0.1.12>
- Structured result: `docs/release/manual-validation-v0.1.12.result.json`
...
- [ ] Install or open the packaged app from the release asset `Hosts.Switch_0.1.12_aarch64.dmg`.
...
- Update `docs/release/manual-validation-v0.1.12.result.json` with the same outcome.
