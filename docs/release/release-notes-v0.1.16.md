...
这是 Hosts Switch 的 macOS 预发布构建，用于验证 Tauri + React 版 hosts 切换工具。`v0.1.16` 基于 `v0.1.15` 继续补强状态栏切换体验、原生 profiles 可恢复性和菜单栏工具窗口行为。
...
- GitHub Release notes 继续从仓库内受校验的 `docs/release/release-notes-v0.1.16.md` 渲染发布，减少发布页面和源码记录不一致。
...
Automated prerelease build for v0.1.16.

Artifact:

- Hosts.Switch_0.1.16_aarch64.dmg
- SHA-256: `015342302f21d69dd9a5849c021e0eae8ef49b83d148d9f1cc7a48e6b1dcdcfc`
