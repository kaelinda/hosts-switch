# Hosts Switch v0.1.15 Manual Validation
...
- Tag: `v0.1.15`
- Release asset: `Hosts.Switch_0.1.15_aarch64.dmg`
- Local bundle name: `Hosts Switch_0.1.15_aarch64.dmg`
- Release: <https://github.com/kaelinda/hosts-switch/releases/tag/v0.1.15>
- Structured result: `docs/release/manual-validation-v0.1.15.result.json`
...
- [ ] Install or open the packaged app from the verified release asset `manual-validation-artifacts/v0.1.15/Hosts.Switch_0.1.15_aarch64.dmg`.
...
- Update `docs/release/manual-validation-v0.1.15.result.json` with the same outcome.
