# Hosts Switch v0.1.13 Manual Validation
...
- Tag: `v0.1.13`
- Release asset: `Hosts.Switch_0.1.13_aarch64.dmg`
- Local bundle name: `Hosts Switch_0.1.13_aarch64.dmg`
- Release: <https://github.com/kaelinda/hosts-switch/releases/tag/v0.1.13>
- Structured result: `docs/release/manual-validation-v0.1.13.result.json`
...
- Update `docs/release/manual-validation-v0.1.13.result.json` with the same outcome.
