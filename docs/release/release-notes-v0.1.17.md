...
这是 Hosts Switch 的 macOS 预发布构建，用于验证 Tauri + React 版 hosts 切换工具。`v0.1.17` 基于 `v0.1.16` 继续补强状态栏切换失败态、手工验收记录和菜单栏工具窗口行为。
...
- GitHub Release notes 继续从仓库内受校验的 `docs/release/release-notes-v0.1.17.md` 渲染发布，减少发布页面和源码记录不一致。
...
Automated prerelease build for v0.1.17.

Artifact:

- Hosts.Switch_0.1.17_aarch64.dmg
- SHA-256: `f3faef43fa3f72cef2e1d39166f7d2a7d771db919a7b3169aee90e7e2feced54`
