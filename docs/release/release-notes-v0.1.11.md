...
这是 Hosts Switch 的 macOS 预发布构建，用于验证 Tauri + React 版 hosts 切换工具。
...
Automated prerelease build for v0.1.11.

Artifact:

- Hosts.Switch_0.1.11_aarch64.dmg
- SHA-256: `ca71a9f9227536bc168eadfa1b757b1c7961936ede33d61f6ee171aea5c494a8`
