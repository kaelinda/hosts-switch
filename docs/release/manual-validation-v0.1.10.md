# Hosts Switch v0.1.10 Manual Validation
...
- Tag: `v0.1.10`
- Release asset: `Hosts.Switch_0.1.10_aarch64.dmg`
- Local bundle name: `Hosts Switch_0.1.10_aarch64.dmg`
- Release: <https://github.com/kaelinda/hosts-switch/releases/tag/v0.1.10>
- Structured result: `docs/release/manual-validation-v0.1.10.result.json`
...
- Update `docs/release/manual-validation-v0.1.10.result.json` with the same outcome.
