# Hosts Switch v0.1.14 Manual Validation
...
- Tag: `v0.1.14`
- Release asset: `Hosts.Switch_0.1.14_aarch64.dmg`
- Local bundle name: `Hosts Switch_0.1.14_aarch64.dmg`
- Release: <https://github.com/kaelinda/hosts-switch/releases/tag/v0.1.14>
- Structured result: `docs/release/manual-validation-v0.1.14.result.json`
...
- [ ] Install or open the packaged app from the verified release asset `manual-validation-artifacts/v0.1.14/Hosts.Switch_0.1.14_aarch64.dmg`.
